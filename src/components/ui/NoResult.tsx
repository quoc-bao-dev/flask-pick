  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 px-4">
      ...
      <div className="mb-6 w-48 h-48 flex items-center justify-center">
        ...
        <img src={_Image["no-result"]} alt="No Data" width={250} height={250} className="w-full h-full object-cover" />
      </div>

      {/* Title */}
      <h3 className="text-[16px] font-medium leading-4 text-center text-gray-2 mb-3">
        {title}
      </h3>
