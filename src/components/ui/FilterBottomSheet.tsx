    ...
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 bg-white rounded-t-3xl shadow-lg animate-in slide-in-from-bottom duration-300 max-h-[90vh] overflow-y-auto">
        ...
        <div className="relative px-4 py-4 space-y-6 overflow-x-hidden max-w-full">
          {/* Sắp xếp theo */}
          <div>
            <h3 className="text-[14px] font-semibold text-[var(--color-text-strong)] mb-3 uppercase">
              SẮP XẾP THEO
            </h3>
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-[14px] font-semibold transition-colors ${
                    sortBy === option.key
                      ...
                      : "bg-white border border-[var(--color-border-1)] text-[var(--color-text-strong)]"
                  }`}
                >
                  {option.label}
                </button>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                <div className="flex-1">
                  <label className="text-[12px] text-gray-3 mb-1 block">
                    Từ
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full px-3 py-2 border border-[var(--color-border-1)] rounded-lg text-[14px] focus:outline-none focus:border-[var(--color-orange-1)]"
                    placeholder="₫"
                  />
                </div>
                <div className="flex-1">
          ...
          <div className="pt-2">
            ...
            >
              <div className="flex gap-2 items-center">
                <CategoryIcon />
                <p className=" text-sm ">
                  {CATEGORY_OPTIONS.find((c) => c.id === selectedCategory)
                    ?.label || "Chọn danh mục"}
                </p>
              </div>
            ...
            >
              <div className="flex items-center gap-3 px-3 py-3">
                <button
                  ...
                  className="w-9 h-9 flex items-center justify-center rounded-full border border-[var(--color-border-1)] bg-white text-gray-600"
                >
                  <svg
                    width="18"
                    height="18"
                ...
                <h2 className="text-sm font-semibold text-[var(--color-text-strong)] uppercase">
                  Danh mục
                </h2>
              </div>
